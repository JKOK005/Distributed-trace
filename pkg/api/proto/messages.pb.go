...
func (m *Ping) GetHostAddr() string {
	if m != nil {
		return m.HostAddr
	}
	return ""
...
func (m *Ping) GetMsgTimeNano() uint32 {
	if m != nil {
...
func (m *Ping) GetSeedNodeAddr() string {
	if m != nil {
...
func (m *PingResp) GetIsSuccess() bool {
	if m != nil {
		return m.IsSuccess
	}
	return false
...
func init() {
	...
	proto.RegisterType((*PingResp)(nil), "message.PingResp")
...
var fileDescriptor_4dc296cbfe5ffcd5 = []byte{
	...
	,
}
...
type DistributedTracingServiceClient interface {
	PingNode(ctx context.Context, in *Ping, opts ...grpc.CallOption) (*PingResp, error)
...
func (c *distributedTracingServiceClient) PingNode(ctx context.Context, in *Ping, opts ...grpc.CallOption) (*PingResp, error) {
	out := new(PingResp)
...
type DistributedTracingServiceServer interface {
	PingNode(context.Context, *Ping) (*PingResp, error)
...
func (*UnimplementedDistributedTracingServiceServer) PingNode(ctx context.Context, req *Ping) (*PingResp, error) {
...
func _DistributedTracingService_PingNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DistributedTracingServiceServer).PingNode(ctx, req.(*Ping))
	}
